...
Options:
    ...
    --plan=<value>                          usage plan name
    --revoke-access=<true|false>            [default: false] enables/ disable the apikey
    --access-sync=<true|false>              [default: true] grant sync access
    --access-road-registry=<true|false>     [default: false] grant road access
